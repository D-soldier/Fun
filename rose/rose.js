    ...
    if( A * A + B * B < 1 ){
        ...
        if ( c > 37 ) {
            ...
            return {
                ...
                r: 0.4 - a * 0.1 + Math.pow( 1 - B * B, -h * 6 ) * 0.15 - a * b * 0.4 + Math.cos( a + b ) / 5 + Math.pow( Math.cos( (o * ( a + 1 ) + (B > 0 ? w : -w)) / 25), 30 ) * 0.1 * ( 1 - B * B),
        ...
        var z = o * Math.sin( c ) + w * Math.sin( c ) + 700;
